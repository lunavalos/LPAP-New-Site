...
export default async function Footer() {
  ...
  const igLink = socialLinks.find((l: any) => l.platform === 'instagram')?.url || 'https://www.instagram.com/luchandoporangelespequenos/?hl=es'
  const waLink = socialLinks.find((l: any) => l.platform === 'whatsapp')?.url || 'https://wa.me/528442281480'
        ...
        <div className={styles.grid}>
          <div className={styles.col}>
            ...
            <div className={styles.socials}>
              {fbLink && (
                <a href={fbLink} target="_blank" rel="noopener noreferrer" className={`${styles.socialBubble} ${styles.facebook}`} aria-label="Facebook">
              ...
              {igLink && (
                <a href={igLink} target="_blank" rel="noopener noreferrer" className={`${styles.socialBubble} ${styles.instagram}`} aria-label="Instagram">
              ...
              {waLink && (
                <a href={waLink} target="_blank" rel="noopener noreferrer" className={`${styles.socialBubble} ${styles.whatsapp}`} aria-label="WhatsApp">
